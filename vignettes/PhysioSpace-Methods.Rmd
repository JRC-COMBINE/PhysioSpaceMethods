...
'InputData' has to be <sup>1-</sup> a matrix, with <sup>2-</sup> genes in
rows, <sup>3-</sup> identified by Entrez IDs which are stored in 'rownames' of
the matrix, and <sup>4-</sup> samples in columns, <sup>5-</sup> identified by
sample names stored in 'colnames' of the matrix. Lastly, <sup>6-</sup> values
of InputData matrix should be relative, e.g. fold changes of genes, rather
than pure gene expressions. In our example, we prepare the InputData by taking
four steps listed as follows:

* **Converting gene expression data into a matrix:** PhysioSpaceMethods
expects a matrix as input. In this example 
...
this example we aim to 
match RNA-seq counts of different human tissues to their corresponding tissues
in a micro-array compendium, we use the tissue 
...
relative gene expression matrix, and Space, 
...
PhysioHeatmap(PhysioResults = RESULTS5Random, main = "RNA-seq vs Microarray",
            SymmetricColoring = T, SpaceClustering = T, Space = HS_LUKK_Space,
                                                          ReducedPlotting = 5)
```
![Figure 1. Similarities Heatmap of RNA-seq 
tissue samples of E-MTAB-2836 vs. Lukk et al. Space made from 
microarray tissue samples](RESULTSHeatmap.png "RESULTS Heatmap")
...
modelling and stattistical testing, you can check limma package
documentation).
```r
...
SymmetricColoring = T, SpaceClustering = T, Space = AT_Stress_Space, 
                                                              PlotSize = 21)
```
![Figure 2. Similarities Heatmap of cold stressed A.thaliana samples 
...
other attached packages:
 ...
 [1] PlantPhysioSpace_0.9.0      limma_3.37.3                ath1121501cdf_2.18.0        affy_1.59.0                
 [5] HumanPhysioSpace_0.0.0.9000 PhysioSpaceMethods_0.99.0   biomaRt_2.37.3              SummarizedExperiment_1.11.6
 [9] DelayedArray_0.7.24         BiocParallel_1.15.8         matrixStats_0.54.0          Biobase_2.41.2             
[13] GenomicRanges_1.33.13       GenomeInfoDb_1.17.1         IRanges_2.15.16             S4Vectors_0.19.19          
[17] BiocGenerics_0.27.1        

####
loaded via a namespace (and not attached):

  [1] minqa_1.2.4            colorspace_1.3-2       class_7.3-14           htmlTable_1.12         XVector_0.21.3        
  [6] base64enc_0.1-3        rstudioapi_0.7         mice_3.3.0             affyio_1.51.0          bit64_0.9-7           
 [11] mvtnorm_1.0-8          AnnotationDbi_1.43.1   missMDA_1.13           codetools_0.2-15       splines_3.5.1         
 [16] leaps_3.0              doParallel_1.0.11      geneplotter_1.59.0     knitr_1.20             DMwR_0.4.1            
 [21] Formula_1.2-3          nloptr_1.0.4           broom_0.5.0            annotate_1.59.1        cluster_2.0.7-1       
 [26] compiler_3.5.1         httr_1.3.1             backports_1.1.2        assertthat_0.2.0       Matrix_1.2-14         
 [31] lazyeval_0.2.1         acepack_1.4.1          htmltools_0.3.6        prettyunits_1.0.2      tools_3.5.1           
 [36] bindrcpp_0.2.2         gtable_0.2.0           glue_1.3.0             GenomeInfoDbData_1.1.0 dplyr_0.7.6           
 [41] FactoMineR_1.41        Rcpp_0.12.18           preprocessCore_1.43.0  gdata_2.18.0           nlme_3.1-137          
 [46] iterators_1.0.10       stringr_1.3.1          lme4_1.1-17            gtools_3.8.1           XML_3.98-1.13         
 [51] pan_1.6                zlibbioc_1.27.0        MASS_7.3-50            zoo_1.8-3              scales_0.5.0          
 [56] BiocInstaller_1.31.1   hms_0.4.2              RColorBrewer_1.1-2     yaml_2.2.0             quantmod_0.4-13       
 [61] curl_3.2               memoise_1.1.0          gridExtra_2.3          ggplot2_3.0.0          rpart_4.1-13          
 [66] latticeExtra_0.6-28    stringi_1.2.4          RSQLite_2.1.1          genefilter_1.63.0      foreach_1.4.4         
 [71] checkmate_1.8.5        TTR_0.23-3             caTools_1.17.1.1       rlang_0.2.1            pkgconfig_2.0.1       
 [76] bitops_1.0-6           lattice_0.20-35        ROCR_1.0-7             purrr_0.2.5            bindr_0.1.1           
 [81] htmlwidgets_1.2        bit_1.1-14             tidyselect_0.2.4       plyr_1.8.4             magrittr_1.5          
 [86] DESeq2_1.21.12         R6_2.2.2               gplots_3.0.1           Hmisc_4.1-1            mitml_0.3-6           
 [91] DBI_1.0.0              pillar_1.3.0           foreign_0.8-71         xts_0.11-0             survival_2.42-6       
 [96] scatterplot3d_0.3-41   abind_1.4-5            RCurl_1.95-4.11        nnet_7.3-12            tibble_1.4.2          
[101] crayon_1.3.4           jomo_2.6-3             KernSmooth_2.23-15     progress_1.2.0         locfit_1.5-9.1        
[106] grid_3.5.1             data.table_1.11.4      blob_1.1.1             digest_0.6.15          flashClust_1.01-2     
[111] xtable_1.8-2           tidyr_0.8.1            munsell_0.5.0         

...
#' "GenesRatio*100" percent highest and lowest gene expression values of
#' each sample. GenesRatio should be a numerical value between 0 and 1.
...
#' @param STATICResponse Logical value indicating if 'statistic' should
#' be returned rather than the default 'signed p value'.
